...
export default function InsyloGuide() {
  return (
      ...
      <section className="bg-gradient-to-br from-primary-dark via-primary to-primary-dark text-white py-12">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <nav className="text-sm mb-6 text-white/60">
            ...
            <span className="mx-2">/</span>
            <span className="text-white">Insylo</span>
          </nav>
          <div className="flex items-center gap-4">
            ...
            <div>
              <h1 className="text-3xl lg:text-4xl font-bold">Insylo</h1>
              <p className="text-white/70">Sistema de monitoreo de silos</p>
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <div className="bg-bg-alt rounded-2xl p-12">
            ...
            <p className="text-text-light mb-6">
              La guía detallada de instalación para Insylo estará disponible pronto.
            </p>
            <Link
              href="/guias"
